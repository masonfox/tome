...
# DEPRECATED: This script has been replaced by scripts/backup.ts
# Please use: npm run db:backup
#
# This file will be removed in a future release.
# The new TypeScript version provides:
# - Backup of both Tome and Calibre databases
# - Better error handling and logging
# - Consistent behavior between Docker and manual usage
