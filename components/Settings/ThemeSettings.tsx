  ...
  return (
    <div className="bg-[var(--card-bg)] border border-[var(--border-color)] rounded-md p-6">
      ...
      <div className="space-y-2">
        {/* Light Mode */}
        <label className="flex items-center gap-3 cursor-pointer p-2 rounded-md hover:bg-[var(--border-color)]/30 transition-colors">
          <input
            type="radio"
            name="theme"
            value="light"
          ...
          <div className="flex-1">
            <span className="font-semibold text-[var(--foreground)]">Light</span>
            <span className="text-sm text-[var(--subheading-text)]"> — Always use light mode</span>
          </div>
        </label>
        ...
        <label className="flex items-center gap-3 cursor-pointer p-2 rounded-md hover:bg-[var(--border-color)]/30 transition-colors">
          ...
          />
          <div className="flex-1">
            <span className="font-semibold text-[var(--foreground)]">Dark</span>
            <span className="text-sm text-[var(--subheading-text)]"> — Always use dark mode</span>
          </div>
        </label>
        ...
        <label className="flex items-center gap-3 cursor-pointer p-2 rounded-md hover:bg-[var(--border-color)]/30 transition-colors">
          ...
          <div className="flex-1">
            ...
            <span className="text-sm text-[var(--subheading-text)]"> — Match system preferences</span>
            {preference === "auto" && (
