  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <div className="flex items-center gap-2 animate-pulse">
        ...
        <div className="h-[36px] w-[36px] bg-[var(--card-bg)] border border-[var(--border-color)] rounded-sm flex items-center justify-center">
          <div className="w-4 h-4 bg-[var(--foreground)]/10 rounded" />
        </div>

        {/* Dropdown skeleton - matches min-w-[140px] */}
        <div className="h-[36px] min-w-[140px] bg-[var(--card-bg)] border border-[var(--border-color)] rounded-sm px-4 flex items-center">
