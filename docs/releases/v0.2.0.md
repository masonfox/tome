...
This release introduces major user experience improvements with iOS-style navigation, book editing capabilities, and numerous bug fixes for streak tracking and timezone handling.

## ✨ What's New

### 📱 iOS-Style Bottom Navigation (#76)
...
- Increased stroke opacity: 0.5 → 0.9
- Increased label opacity: 0.7 → 1.0
...
This release includes extensive test coverage:
...
- Various workflow files - Removed redundant steps
...
1. **Bottom Navigation**: Disabled by default, enable in Settings → Navigation Style
